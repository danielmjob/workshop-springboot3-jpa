...
public class TestConfig implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Payment pay1 = new Payment(null,Instant.parse("2019-06-20T21:53:07Z"),o1); // mudando o horario para duas horas depois
		o1.setPayment(pay1); // associando o pedido 1 com o pagamento 1
		orderRepository.save(o1); // salvando pagamento do pedido
